<template>
  <div>
    <h1>Privacy Policy for Voice Activated Fitness</h1>

    <p>At Voice Activated Fitness, accessible from https://fyp-voice-activated-fitness.herokuapp.com/, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is
      collected and recorded by Voice Activated Fitness and how we use it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
      to the information that they shared and/or collect in Voice Activated Fitness. This policy is not applicable to
      any information collected offline or via channels other than this website. Our Privacy Policy was created with the
    ...
    <p>Voice Activated Fitness follows a standard procedure of using log files. These files log visitors when they visit
    ...
    <p>Like any other website, Voice Activated Fitness uses 'cookies'. These cookies are used to store information
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Voice Activated
      Fitness.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on Voice Activated Fitness, which are sent directly to
    ...
    <p>Note that Voice Activated Fitness has no access to or control over these cookies that are used by third-party
      advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>Voice Activated Fitness's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
    ...
    <p>Voice Activated Fitness does not knowingly collect any Personal Identifiable Information from children under the
