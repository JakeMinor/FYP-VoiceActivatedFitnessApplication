/**
 * A List of all the equipment which are to be seeded into the Database.
 */
...
/**
 * A List of all the exercises which are to be seeded into the database.
 */
module.exports.exercises = [
 ...
 {
  name: "Banded pullups",
  information: "A Banded pullup is an upper-body exercise where the trainee hangs from a bar with their feet or knees supported by a resistance band with their palms facing away from them. They then pull themselves up to the bar so that their chest touches the bar, using a resistance band will make the movement easier due to the force the resistance band supplies."
 },
 {
  name: "Chinup",
